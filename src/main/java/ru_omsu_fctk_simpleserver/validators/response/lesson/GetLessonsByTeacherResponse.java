package ru_omsu_fctk_simpleserver.validators.response.lesson;
...
public class GetLessonsByTeacherResponse {
    ...
    public GetLessonsByTeacherResponse(String groupName, String teacherName, String teacherSurname, String teacherPatronymic,
